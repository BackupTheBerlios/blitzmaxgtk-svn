...
Else
	...
	If KeyWordsFile = Null Then
		Scream("Konnte Keywords-Datei nicht �fnen")
	Else
...
Function OpenClick(Widget:Byte Ptr,AdditionalData:Byte Ptr,GdkEvent:Byte Ptr)
	...
	Local dialog:GtkFileChooserDialog = GtkFileChooserDialog.CreateFCD(ISO_8859_1_To_UTF_8("Datei �fnen"),Null,GTK_FILE_CHOOSER_ACTION_OPEN,"gtk-open",GTK_RESPONSE_OK,"gtk-cancel",GTK_RESPONSE_CANCEL)
...
Function BuildModules()
	...
	End If
	Notebook.SetCurrentPage(1)
	TProcLib.Say("Starte das Kompilieren ge�derter Module...")
	TProcLib.CreateProcess(bmxpath+"/bin/bmk",bmkArgs)
End Function
Function killApp()
...
Function SaveRecentList()
	...
	If rstream = Null Then
		Scream("Konnte " + recentfile + " nicht zum Schreiben �fnen")
	EndIf
