...
SCLEX_ASP%=29
SCLEX_PHP%=30
scintilla_new@*()="scintilla_new"
scintilla_get_type@*()="scintilla_get_type"
scintilla_send_message%(Scintilla@*,uno%,due@*,tre@*)="scintilla_send_message"
SCNotification^Object{
.code%&
.position%&
.ch%&
.modifiers%&
...
.x%&
.y%&
-New%()="_gtk_scintilla_SCNotification_New"
-Delete%()="_gtk_scintilla_SCNotification_Delete"
}="gtk_scintilla_SCNotification"
GtkScintilla^GtkWidget{
.ScintillaHandle@*&
-New%()="_gtk_scintilla_GtkScintilla_New"
-Delete%()="_gtk_scintilla_GtkScintilla_Delete"
+Create:GtkScintilla()="_gtk_scintilla_GtkScintilla_Create"
+CreateFromHandle:GtkScintilla(Handle@*)="_gtk_scintilla_GtkScintilla_CreateFromHandle"
-InsertText%(Text$,Pos%=0)="_gtk_scintilla_GtkScintilla_InsertText"
-AppendText%(Text$)="_gtk_scintilla_GtkScintilla_AppendText"
-AddText%(Text$)="_gtk_scintilla_GtkScintilla_AddText"
-GetLine$(Line%)="_gtk_scintilla_GtkScintilla_GetLine"
-GetLineCount%()="_gtk_scintilla_GtkScintilla_GetLineCount"
-ClearAll%()="_gtk_scintilla_GtkScintilla_ClearAll"
-ClearStyle%()="_gtk_scintilla_GtkScintilla_ClearStyle"
-SetLexer%(What%)="_gtk_scintilla_GtkScintilla_SetLexer"
-GetLexer%()="_gtk_scintilla_GtkScintilla_GetLexer"
-SetStyleBits%(StyleBits%)="_gtk_scintilla_GtkScintilla_SetStyleBits"
-GetStyleBits%()="_gtk_scintilla_GtkScintilla_GetStyleBits"
-SetKeywords%(KeywordSet%,KeywordList$)="_gtk_scintilla_GtkScintilla_SetKeywords"
-SetKeywordList%(KeywordSet%,KeywordList:TList)="_gtk_scintilla_GtkScintilla_SetKeywordList"
-SetFont%(ForWhat%,Name$=$"",Size%=-1,ColorR%=-1,ColorG%=-1,ColorB%=-1,Bold@=2,Underlined@=2,Italic@=2)="_gtk_scintilla_GtkScintilla_SetFont"
-SetFontBGColor%(ForWhat%,ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetFontBGColor"
-EncodeColor%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_EncodeColor"
-DecodeColor%(tmpval%,ColorR@*,ColorG@*,ColorB@*)="_gtk_scintilla_GtkScintilla_DecodeColor"
-SetBGColor%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetBGColor"
-SetMarginType%(Num%,MType%)="_gtk_scintilla_GtkScintilla_SetMarginType"
-GetMarginType%(Num%)="_gtk_scintilla_GtkScintilla_GetMarginType"
-SetMarginMask%(Num%,Mask%)="_gtk_scintilla_GtkScintilla_SetMarginMask"
-GetMarginMask%(Num%)="_gtk_scintilla_GtkScintilla_GetMarginMask"
-SetMarginWidth%(Num%,Width%)="_gtk_scintilla_GtkScintilla_SetMarginWidth"
-GetMarginWidth%(Num%)="_gtk_scintilla_GtkScintilla_GetMarginWidth"
-SetMarginSensitive%(Num%,Sensitive@)="_gtk_scintilla_GtkScintilla_SetMarginSensitive"
-GetMarginSensitive@(Num%)="_gtk_scintilla_GtkScintilla_GetMarginSensitive"
-SetCaretColor%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetCaretColor"
-GetCaretColor%(ColorR@*,ColorG@*,ColorB@*)="_gtk_scintilla_GtkScintilla_GetCaretColor"
-SetCaretLineVisible%(Visible@)="_gtk_scintilla_GtkScintilla_SetCaretLineVisible"
-GetCaretLineVisible@()="_gtk_scintilla_GtkScintilla_GetCaretLineVisible"
-SetCaretLineBack%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetCaretLineBack"
-GetCaretLineBack%(ColorR@*,ColorG@*,ColorB@*)="_gtk_scintilla_GtkScintilla_GetCaretLineBack"
-SetSelectionFore%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetSelectionFore"
-SetSelectionBack%(ColorR@,ColorG@,ColorB@)="_gtk_scintilla_GtkScintilla_SetSelectionBack"
-DisableSelectionFore%()="_gtk_scintilla_GtkScintilla_DisableSelectionFore"
-DisableSelectionBack%()="_gtk_scintilla_GtkScintilla_DisableSelectionBack"
-SetTabWidth%(Width%)="_gtk_scintilla_GtkScintilla_SetTabWidth"
-GetTabWidth%(Width%)="_gtk_scintilla_GtkScintilla_GetTabWidth"
-SetProperty%(Key$,Value$)="_gtk_scintilla_GtkScintilla_SetProperty"
-DefineMarker%(Marker%,Symbols%,ForeR@=0,ForeG@=0,ForeB@=0,BackR@=0,BackG@=0,BackB@=0)="_gtk_scintilla_GtkScintilla_DefineMarker"
-GetLineFromPosition%(Position%)="_gtk_scintilla_GtkScintilla_GetLineFromPosition"
-GetCurrentPosition%()="_gtk_scintilla_GtkScintilla_GetCurrentPosition"
-ToggleFoldPoint%(Line%)="_gtk_scintilla_GtkScintilla_ToggleFoldPoint"
-Cut%()="_gtk_scintilla_GtkScintilla_Cut"
-Copy%()="_gtk_scintilla_GtkScintilla_Copy"
-Paste%()="_gtk_scintilla_GtkScintilla_Paste"
-Undo%()="_gtk_scintilla_GtkScintilla_Undo"
-CanUndo@()="_gtk_scintilla_GtkScintilla_CanUndo"
-Redo%()="_gtk_scintilla_GtkScintilla_Redo"
-CanRedo@()="_gtk_scintilla_GtkScintilla_CanRedo"
-EmptyUndoBuffer%()="_gtk_scintilla_GtkScintilla_EmptyUndoBuffer"
